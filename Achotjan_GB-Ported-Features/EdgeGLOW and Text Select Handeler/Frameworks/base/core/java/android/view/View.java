...
public class View implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    */
     ...
     * @hide
     */
    public static final int OVERSCROLL_SETTING_EDGEGLOW = 1;
    /**
     * @hide
     */
    public static final int OVERSCROLL_SETTING_BOUNCEGLOW = 2;
    /**
     * @hide
     */
    public static final int OVERSCROLL_SETTING_BOUNCE = 3;
        ...
        for (int i = 0; i < N; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.View_overscrollMode:
                    overScrollMode = a.getInt(attr, OVERSCROLL_IF_CONTENT_SCROLLS);
                    break;
            }
        }
    ...
    */
    ...
    public int getOverScrollMode() {
       ...
       Settings.System.OVERSCROLL_EFFECT, OVERSCROLL_SETTING_EDGEGLOW);
