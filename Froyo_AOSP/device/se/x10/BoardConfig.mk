...
-include vendor/se/x10/BoardConfigVendor.mk
USE_CAMERA_STUB := false
...
BOARD_EGL_CFG := device/se/x10/egl.cfg
...
BOARD_WLAN_DEVICE           := ath6002
WIFI_DRIVER_MODULE_PATH     := "/system/lib/modules/wifi.ko"
WIFI_DRIVER_FW_STA_PATH     := "/system/lib/modules/athwlan.bin.z77"
WIFI_DRIVER_FW_AP_PATH      := "/system/lib/modules/athwlan.bin.z77"
WIFI_DRIVER_MODULE_ARG      := "firmware_path=/system/lib/modules/athwlan.bin.z77 nvram_path=/proc/calibration"
WIFI_DRIVER_MODULE_NAME     := "wifi"
...
TARGET_RELEASETOOLS_EXTENSIONS := device/se/common
